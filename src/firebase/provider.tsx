...
import { Firestore, doc, Timestamp } from 'firebase/firestore';
...
export interface FirebaseContextState {
  ...
  userProfile: WithId<UserProfileData> | null;
...
export const FirebaseProvider: React.FC<FirebaseProviderProps> = ({
  ...
  const { data: userProfile, isLoading: isUserProfileLoading, error: userProfileError } = useDoc<UserProfileData>(userDocRef);
  ...
  const contextValue = useMemo((): FirebaseContextState => {
    ...
    return {
      ...
      userError: userAuthState.userError || userProfileError,
      userProfile,
      isUserProfileLoading,
    };
  }, [firebaseApp, firestore, auth, userAuthState, userProfile, isUserProfileLoading, userProfileError]);
